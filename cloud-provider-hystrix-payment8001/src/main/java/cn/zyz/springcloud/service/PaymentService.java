...
public class PaymentService {
    public String paymentInfo_OK(Integer id) {
        return "线程池" + Thread.currentThread().getName() + "paymentInfo-OK,id:" + id + "\t" + "哈哈~O(∩_∩)O";
    }
    ...
    /*
        当添加@HystrixCommand注解的方法超过了限制时间或者当方法中出现了异常时，就执行该方法
        这个方法是由@HystrixCommand注解中的fallbackMethod参数来指定的
     */
